...
// we will cover if, else , else if statements. The comparison and logical operators we learned in the previous sections will be useful in here.
...
// If Else if Else
// ------------------------------------------------------------------------------------------------------
// On our daily life, we make decisions on daily basis.
...
let isRainingThree = true;
isRainingThree
  ? console.log('You need a rain coat.')
  : console.log('No need for a rain coat.');

// 🌕 You are extraordinary and you have a remarkable potential.
// You have just completed day 4 challenges and you are four steps ahead to your way to greatness.
